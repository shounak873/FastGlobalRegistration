...
empty_directory('/home/navlab-shounak/Desktop/RegResults/Huber/clean_output')
...
for i in range(25):
    ...
    proc = subprocess.run(["build/FastGlobalRegistration/FastGlobalRegistration",
                           ...
                           "/home/navlab-shounak/Desktop/RegResults/Huber/clean_output/" + str(i+1) + "_rot_05_output" + ".txt"])
    ...
    proc2 = subprocess.run(["build/FastGlobalRegistration/Evaluation",
                            ...
                            "/home/navlab-shounak/Desktop/RegResults/Huber/clean_output/" +
