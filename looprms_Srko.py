...
empty_directory('/home/navlab-shounak/Desktop/RegResults/SRKO/clean')
empty_directory('/home/navlab-shounak/Desktop/RegResults/SRKO/clean_output')
...
for i in range(25):
    proc = subprocess.run(["build/FastGlobalRegistration/FastGlobalRegistration",
                           ...
                           "/home/navlab-shounak/Desktop/RegResults/SRKO/clean_output/" + str(i+1) + "_rot_05_output" + ".txt"])
    ...
    proc2 = subprocess.run(["build/FastGlobalRegistration/Evaluation",
                            ...
                            "/home/navlab-shounak/Desktop/RegResults/SRKO/clean_output/" +
                            str(i+1) + "_rot_05_output" + ".txt",
                            "/home/navlab-shounak/Desktop/RegResults/SRKO/clean/no_noise_eval_collection_" + str(i+1) + ".txt"])
    # proc.wait()
    # proc.kill()
